...
## My Application
For my application I chose to use a photo of the Brisbane Broncos rugby team. When running the app, you can see the color matched background, as well as the color matched font below the image.
